...
public class TituloController {
	...
	public String salvar(@Validated Titulo titulo, Errors error, RedirectAttributes attributes) { 
		...
		try {
			...
			attributes.addFlashAttribute("mensagem", "Titulo salvo com sucesso!"); // quando estiver chegando na view atributo mensagem estara disponivel no html		
	...
	public String excluir(@PathVariable Titulo codigo, RedirectAttributes attributes) {
